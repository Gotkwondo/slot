...
const NaverShoppingRequestManage = () => {
  ...
  const trafficState = useTrafficSelectListContext('SHOP');
  const tableHeaderState = useTableHeaderContext('SHOP');

  useEffect(() => {
    if (!searchParams.has('page')) {
      navigate('/naver-shopping-request-manage?page=1');
    }
  }, [searchParams]);
...
export { NaverShoppingRequestManage };
